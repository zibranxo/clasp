...
PROVIDER_CATALOG: dict[str, ProviderProfile] = {
    ...
    "mistral_codestral": ProviderProfile(
        ...
        max_context_tokens=32_768,
        tier="free",
        free_tier_note="30 RPM free • console.mistral.ai",
    ),
    ...
    "deepseek": ProviderProfile(
        ...
        max_context_tokens=128_000,
        tier="free_credits",
        free_tier_note="Free signup credits • platform.deepseek.com",
    ),
    ...
    "kimi": ProviderProfile(
        ...
        max_context_tokens=128_000,
        tier="free",
        free_tier_note="Free tier • platform.moonshot.cn",
    ),
    ...
    "llamacpp": ProviderProfile(
        ...
        max_context_tokens=32_768,
        tier="local",
        free_tier_note="Unlimited • Runs on your machine • github.com/ggml-org/llama.cpp",
    ),
    ...
    "opencode": ProviderProfile(
        ...
        max_context_tokens=32_768,
        tier="free",
        free_tier_note="Free tier • opencode.ai",
    ),
    ...
    "wafer": ProviderProfile(
        ...
        max_context_tokens=128_000,
        tier="free",
        free_tier_note="Free tier • wafer.ai",
    ),
    ...
    "zai": ProviderProfile(
        ...
        max_context_tokens=128_000,
        tier="free_credits",
        free_tier_note="Free signup credits • z.ai",
    ),
}
